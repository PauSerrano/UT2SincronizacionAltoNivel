...
public class DemoColaCarrefour {
	public static void main(String[] args) {
		...
		BlockingQueue<Cliente> q = new ArrayBlockingQueue<Cliente>(100);
		...
		GeneradorClientes gClientes = new GeneradorClientes(30,2,1000000000,q);
...
//		}
		Cajero cajero1 = new Cajero(1,1,15,100000,q);
		Cajero cajero2 = new Cajero(2,1,15,100000,q);
		Cajero cajero3 = new Cajero(3,1,15,100000,q);
